export default [
  ...
  { name: 'Service', description: 'These jobs provide miscellanous services, and may be proficient in a tool or kit' },
  { name: 'Smith', description: "These jobs mainly work with metal, and will be proficient in Smith's Tools" },
  { name: 'Specialised', description: 'These are trade jobs that are specialised in nature, and may be proficient in a tool or kit' },
  { name: 'Tailor', description: "These jobs mainly work with fabric, and will be proficient in Weaver's Tools" }
]
